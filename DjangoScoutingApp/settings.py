...
ALLOWED_HOSTS = ['scouting.logangreif.com', 'localhost', '127.0.0.1', '10.36.37.100', 'team3637.logangreif.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                # 'django.template.loaders.cached.Loader',  ENABLE TO IMPROVE PERFORMANCE - LG
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'scouting/static')
]
