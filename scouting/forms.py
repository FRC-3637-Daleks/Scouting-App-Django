...
class MatchData2024Form(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.field_groups = {
            ...
            'Auton': ['left_community_zone', 'a_stopped', 'amp_notes_scored', 'speaker_notes_scored', 'notes_picked_up',],
            'Teleop': ['e_stopped', 'communication_lost', 'speaker_notes_scored' 'amp_notes_scored', 'notes_scored_from_subwoofer','notes_missed'],
