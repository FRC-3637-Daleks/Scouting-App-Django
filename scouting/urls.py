...
urlpatterns = [
    ...
    path('pitdashboard/spawn-terminals/', views.pit_dashboard_spawn_terminals, name="pit_dashboard_spawn_terminals"),
    ...
    path('loading-control/', views.view_recording_control, name="loading_control"),
    path('loading-control', views.view_recording_control),
